...
def Outlier_Detection_Analytically(log_probs,log_probs1):
  ...
  for id_data in log_probs1:
    for ood_data in log_probs1[id_data]:   
        test_listt1=log_probs1[id_data][ood_data]['orig_probs']
        test_listt2=log_probs1[id_data][id_data]['orig_probs']
        
        test_listt3=log_probs1[id_data][ood_data]['corr_probs']
        test_listt4=log_probs1[id_data][id_data]['corr_probs']
